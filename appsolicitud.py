...
# --- 5. ADMIN (VERSIÓN UNIFICADA FINAL) ---
    ...
    # Verificamos si ya es admin o si la contraseña es correcta
        ...
        with tab1:
            ...
            if dfs.empty:
                ...
                if "ID" in dfs.columns:
                    ...
                    if ids:
                        st.divider()
                        # Selector inteligente: selecciona el ÚLTIMO por defecto
